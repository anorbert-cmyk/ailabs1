...
export interface PhaseData {
  ...
  summary?: string;
  /** @deprecated Legacy TL;DR text — use stateHandoff for new code. Kept for backwards compatibility. */
  phaseTldr?: string;
  /** STATE_HANDOFF raw JSON/text extracted from the response (cross-part handoff, NOT displayed). */
  stateHandoff?: string;
}
