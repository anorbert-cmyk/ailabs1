...
Use ## for section headings. Use bullet lists with - for enumerations.
Use markdown tables with | for structured data.
For key findings, use bold **text** for emphasis.
Keep sections clearly separated. Include an Executive Summary first.`,
...
Use ## for section headings. For each competitor, include a subsection with strengths (bullet list), weaknesses (bullet list), and opportunity paragraph.
Use markdown tables where relevant.`,
...
Use ## for section headings. Use numbered phases for the roadmap.
Use markdown tables for timelines and milestones.`,
...
Use ## for section headings. Include detailed specifications.
Use bullet lists for feature breakdowns.`,
...
Include wireframe descriptions and design principles.`
  ...
  4: {
    system: `You are a systems architect specializing in scaling applications. Return in well-structured markdown.
Use ## for section headings. Use bullet lists and tables for specifications.`,
...
Use ## for section headings. Use markdown tables for metrics and ROI calculations.
